...
class RenameSpacesBasedOnThermalZoneNames_Test < Test::Unit::TestCase

  
  def test_RenameSpacesBasedOnThermalZoneNames
     
    # create an instance of the measure
    measure = RenameSpacesBasedOnThermalZoneNames.new
